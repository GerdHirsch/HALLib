...
enum {
NoneBits = 0, AllBits = 0xFFFFFFFF,
Bit0 = 	0x1,	Bit1 = 	1<<1, 	Bit2 = 	1<<2,	Bit3 = 	1<<3, 
...
Bit28 = 1<<28,	Bit29 = 1<<29,	Bit30 = 1<<30,	
Bit31 = 0x80000000 // 1<<31 warning:#61-D: integer operation result is out of range
};
